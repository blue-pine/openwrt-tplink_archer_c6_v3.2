...
nat_config_load_alg() {
	...
	[ "$wanproto" = "dslite" -o "$wanproto" = "v6plus" ] && {
		[ -n "$nat_alg_ftp" ] && nat_alg_ftp="off"
		[ -n "$nat_alg_tftp" ] && nat_alg_tftp="off"
		[ -n "$nat_alg_h323" ] && nat_alg_h323="off"
		[ -n "$nat_alg_rtsp" ] && nat_alg_rtsp="off"
		[ -n "$nat_alg_sip" ] && nat_alg_sip="off"
		[ -n "$nat_alg_pptp" ] && nat_alg_pptp="off"  
		[ -n "$nat_alg_l2tp" ] && nat_alg_l2tp="off"
		[ -n "$nat_alg_ipsec" ] && nat_alg_ipsec="off"
	}
