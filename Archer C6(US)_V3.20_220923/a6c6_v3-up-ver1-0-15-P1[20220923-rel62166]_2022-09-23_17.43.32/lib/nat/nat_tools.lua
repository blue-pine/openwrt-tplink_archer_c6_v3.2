...
local mask
if tonumber(arg[3]) >= 12 then 
    mask = bit.lshift(tonumber(0xffffffff, 16), 32 - tonumber(arg[3])) --arg[3] <= 11 : arithmetic overflow
else
    mask = bit.lshift(tonumber(0xffff, 16), 32 - tonumber(arg[3]))
end
