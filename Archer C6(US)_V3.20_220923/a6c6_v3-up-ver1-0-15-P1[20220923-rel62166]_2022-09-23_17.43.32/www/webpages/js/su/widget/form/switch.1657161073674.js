...
$.su.Widget("switchbutton", {
	...
	create: function(defaults, options){
		...
		container.delegate("a.switch-button-btn", "click", function(e){
			...
			if(obj.beforeHandler){
				var result = obj.beforeHandler();
				if(result){
					return true;
				}
			}
	...
	setValue: function(me, value){
		...
		me.val(value);
		if(dold != dnew){
			me.trigger("ev_change", [dold, dnew]);
		}
		return me;
	},
	disable: function(me) {
	...
	setTips: function(me, tips){
		var me = me || this;
		var container = me.closest("div.switch-button-container");
		var tipsContent = container.find("div.tips-content");
		var tips = tips[1] || "";
