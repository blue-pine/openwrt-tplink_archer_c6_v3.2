...
$.su.Widget("keyword",{
	...
	create: function(defaults, options){
		...
		me.each(function(i, obj){
			...
			var inHTML = 	"<div class=\"container widget-container keyword-container empty"+this.cls+"\">";
			...
			if (this.fieldLabel !== null){
				...
				inHTML +=					"</span>";
				inHTML +=					"<div class=\"keyword-border-left-top\"></div>";
				inHTML +=					"<div class=\"keyword-border-left-bottom\"></div>";
				inHTML +=					"<div class=\"keyword-border-right-top\"></div>";
				inHTML +=					"<div class=\"keyword-border-right-bottom\"></div>";
				inHTML +=				"</a>";
