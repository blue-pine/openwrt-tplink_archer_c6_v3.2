...
$.su.Widget("msg", {
	...
	create: function(defaults, options){
		...
		me.delegate("a.msg-close", "click", function(e){
			...
			$(this).closest("div.msg-container").msg("close", container.get(0).closeHandler);
	...
	show: function(me, arguments){
		...
		var msg_container = $(this).closest("div.msg-container");
		var content_container = msg_container.find("div.msg-wrap");
	...
	setContent: function(me, arguments){ //_content可以是html代码！
		...
		if (text){
			...
			me.find("div.msg-content-container").html(text);
		};
		return me;
	},
